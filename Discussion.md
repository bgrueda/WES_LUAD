...
We present a pipeline based on **GATK** best practices with some other complementary tools to identificate somatic and germline (WIP) variants from WES (whole exome sequencing) sample files.  
